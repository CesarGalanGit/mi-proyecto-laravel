    ...
    public function handle(Request $request): Response
    {
        ...
        return Response::text(json_encode([
            ...
            'car' => [
                ...
                'fuel_type' => $car->fuel_type ? ucfirst($car->fuel_type) : null,
                'transmission' => $car->transmission ? ucfirst($car->transmission) : null,
                'color' => $car->color ? ucfirst($car->color) : null,
                'city' => $car->city ? ucfirst($car->city) : null,
                'status' => $car->status ? ucfirst($car->status) : null,
                'source_name' => $car->source_name ? ucfirst($car->source_name) : null,
